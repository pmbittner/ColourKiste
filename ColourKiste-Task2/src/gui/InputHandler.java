...
public class InputHandler implements MouseListener, MouseMotionListener, MouseWheelListener
{
    ...
    private void cancelButtonAction() {
        buttonHold = -1;
        imagePanel.getCurrentTool().abortUsage();
    }
    ...
    public void mouseClicked(MouseEvent arg0){
        if (arg0.getButton() == MouseEvent.BUTTON1) {
            ...
            if (imagePanel.isPointOnImage(p.getX(), p.getY())) {
                ICommand<Texture> toolCommand = imagePanel.getCurrentTool().use(
    ...
    public void mousePressed(MouseEvent arg0){
        ...
        if (buttonHold == MouseEvent.BUTTON1) {
            Point2D p = imagePanel.screenToTextureCoord(arg0.getX(), arg0.getY());
            imagePanel.getCurrentTool().startUsage(imagePanel.getTexture(), (int)p.getX(), (int)p.getY());
            imagePanel.update();
    ...
    public void mouseReleased(MouseEvent arg0){
        if (buttonHold == arg0.getButton()) {
            if (buttonHold == MouseEvent.BUTTON1) {
                Point2D p = imagePanel.screenToTextureCoord(arg0.getX(), arg0.getY());
                ICommand<Texture> command = imagePanel.getCurrentTool().finishUsage(imagePanel.getTexture(), (int)p.getX(), (int)p.getY());
                if (command != null)
    ...
    public void mouseDragged(MouseEvent arg0){
        if (buttonHold == MouseEvent.BUTTON1) {
            Point2D p = imagePanel.screenToTextureCoord(arg0.getX(), arg0.getY());
            imagePanel.getCurrentTool().updateUsage(imagePanel.getTexture(), (int)p.getX(), (int)p.getY());
        } else if (buttonHold == MouseEvent.BUTTON3) {
